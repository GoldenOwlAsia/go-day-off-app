...
INSERT INTO `absenceTypes` VALUES (1,'Việc gia đình'),(2,'Nghỉ phép năm'),(3,'Nghỉ ốm'),(4,'Nghỉ chế độ'),(5, 'Du lịch');
...
INSERT INTO `userRefToken` VALUES ('5g3bqeTgu6','FeaH0tkYTfVm4ovPQ2x7T0v2vwbJJtMmA0l1wTAJKqu9eTStJ8X3gQ3YAW619STHX6PBJjsQGMhR3eC7','2019-12-05 04:19:02',NULL),('JCJmZbcDmJ','BGSIOWumccaiGCef1mB2jwFxcVMEm002w5tiqw2dFcjwZSzgqRv2MzdtLdQC93Hrx4Hv0kAaiACLoEj2','2019-12-04 09:15:49',NULL);
...
CREATE TABLE `users` (
  ...
  `fNickName` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES ('5g3bqeTgu6','Admin','GO','Anna','fbd79','0123456789','2d61d','1J85n','admin@goldenowl.asia',2,'5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8','admin@goldenowl.asia',1,NULL,NULL,NULL);
...
-- Dump completed on 2019-12-05 14:39:52
